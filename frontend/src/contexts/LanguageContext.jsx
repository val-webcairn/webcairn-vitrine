  ...
  en: {
    ...
    portfolio: {
      ...
      projects: [
        ...
        { name: 'Atelier Terre & Feu', type: 'Ceramic Artisan — Nice', year: '2024', desc: 'A refined portfolio for a ceramist. Workshop showcase, custom orders, and artisan story.', link: 'https://terre-et-feu.webcairn.fr', badge: 'Fictitious Site' },
  ...
  fr: {
    ...
    portfolio: {
      ...
      projects: [
        ...
        { name: 'Atelier Terre & Feu', type: 'Céramiste artisan — Nice', year: '2024', desc: 'Un portfolio raffiné pour un céramiste. Vitrine d\'atelier, commandes personnalisées et histoire artisanale.', link: 'https://terre-et-feu.webcairn.fr', badge: 'Site Fictif' },
